...
@register.filter
def estado_registro(calculo):
    """
    Retorna información del estado del registro
    """
    estado = calculo.get('estado', 'normal')
    mensaje = calculo.get('mensaje', '')
    
    estados = {
        'falta_salida': {'clase': 'danger', 'icono': 'exclamation-triangle', 'texto': 'Falta salida'},
        'falta_entrada': {'clase': 'danger', 'icono': 'exclamation-triangle', 'texto': 'Falta entrada'},
        'registros_iguales': {'clase': 'warning', 'icono': 'exclamation-triangle', 'texto': 'Registro incompleto'},
        'sin_registros': {'clase': 'secondary', 'icono': 'x-circle', 'texto': 'Sin registros'},
        'con_extras': {'clase': 'warning', 'icono': 'clock', 'texto': 'Con horas extras'},
        'normal': {'clase': 'success', 'icono': 'check-circle', 'texto': 'Normal'}
    }
